...
(function () {
     ...
     */
    var URL="/Public/statics/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["undo","redo","unlink","link","cleardoc","separate","insertimage","scrawl","spechars","highlightcode","bold","italic","underline","strikethrough","superscript","subscript"]]
    ...
    //,lang:'zh-cn'
        ...
        ,initialFrameWidth:568  //初始化编辑器宽度,默认1000
        ...
        ,initialStyle:'body{font-size:14px;color:#666666;}'   //编辑器内部样式,可以用来改变字体等
...
//           ]
        ...
        //当输入的字符数超过该值时，保存一次现场
        //,maxInputCount:1
        ,minFrameWidth:480    //编辑器拖动时最小宽度,默认800
